...
"""
import pickle
X_train = np.load('../data/birth_place_trainx_strip.npy')
X_test=np.load('../data/birth_place_testx_strip.npy')
with open('../data/birth_place_trainy_strip.pickle','rb') as f:
    y_train=pickle.load(f)
with open('../data/birth_place_testy_strip.pickle','rb') as f:
