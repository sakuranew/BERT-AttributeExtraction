# os.chdir("./data/birthdate")
import random


def data_gen(k):
    if k == 1:
        f = open('./data/birth_date_train_strip.txt', 'r', encoding='utf-8')
        train_x = []
        train_y = []
        test_x = []
        test_y = []
        ...
        f = open('./data/birth_date_test_strip.txt', 'r', encoding='utf-8')
        ...
        #     for e in alle.items():
        #         for s in e[1]:
        #             sentence = sentence.redate(s, "<" + e2s[e[0]] + str(random.randint(10, 100)) + ">")
        #
        #     # For Chinese
        #     en1pos = sentence.find(en1)
        #     if en1pos == -1:
        ...
        #         sentence = sentence.redate(en1, "<e>")
        #     else:
        #         sentence = sentence.redate(en1, "<v>")
        #
        #     en2pos = sentence.find(en2)
        #     if en2pos == -1:
        #         en2pos = 0
        #     elif dic.get(en2) is not None:
        #         sentence = sentence.redate(en2, "<e>")
        #     else:
        #         sentence = sentence.redate(en2, "<v>")
        ...
        while True:
            ...
            for e in alle.items():
                for s in e[1]:
                    sentence = sentence.redate(s, "<" + e2s[e[0]] + str(random.randint(10, 100)) + ">")
                    # sentence = sentence.redate(s, e2s[e[0]])
